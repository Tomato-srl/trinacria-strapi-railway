...
exports.default = () => ({
    ...
    async uploadContentAsFile(assistantId, content, filename) {
        ...
        try {
            ...
            const fileResponse = await axios_1.default.post('https://api.openai.com/v1/files', formData, {
                headers: {
            ...
            if (fileResponse.data.id) {
                try {
                    ...
                    console.error('Error adding file to assistant vector store:', ((_a = attachError.response) === null || _a === void 0 ? void 0 : _a.data) || attachError.message);
            ...
            console.error('Error uploading content to OpenAI:', ((_b = error.response) === null || _b === void 0 ? void 0 : _b.data) || error.message);
            throw error;
        }
    },
    /**
    ...
    async addFileToAssistantVectorStore(assistantId, fileId) {
        ...
        try {
            ...
            const assistantResponse = await axios_1.default.get(`https://api.openai.com/v1/assistants/${assistantId}`, {
                headers: {
                    'Authorization': `Bearer ${process.env.OPENAI_API_KEY}`,
            ...
            if (!vectorStoreId) {
                ...
                const createVectorStoreResponse = await axios_1.default.post(`https://api.openai.com/v1/vector_stores`, {
                ...
                const updateAssistantResponse = await axios_1.default.post(`https://api.openai.com/v1/assistants/${assistantId}`, {
                    tools: [
                        {
                            type: "file_search"
                        }
                ...
                const updateVectorStoreResponse = await axios_1.default.post(`https://api.openai.com/v1/vector_stores/${vectorStoreId}/files`, {
                    file_id: fileId
                }, {
                    headers: {
                        'Authorization': `Bearer ${process.env.OPENAI_API_KEY}`,
            ...
            console.error('Error adding file to assistant vector store:', ((_a = error.response) === null || _a === void 0 ? void 0 : _a.data) || error.message);
            throw error;
        }
    },
    /**
    ...
    async listAssistantFiles(assistantId) {
        ...
        try {
            ...
            const vectorStoreResponse = await axios_1.default.get(`https://api.openai.com/v1/vector_stores/${vectorStoreId}/files`, {
                headers: {
                    'Authorization': `Bearer ${process.env.OPENAI_API_KEY}`,
                    'OpenAI-Beta': 'assistants=v2',
                    'Content-Type': 'application/json',
            ...
            console.error('Error listing assistant files:', ((_a = error.response) === null || _a === void 0 ? void 0 : _a.data) || error.message);
            throw error;
        }
    },
    /**
    ...
    async retrieveFile(fileId) {
        ...
        try {
            ...
            const response = await axios_1.default.get(`https://api.openai.com/v1/files/${fileId}`, {
                headers: {
                    'Authorization': `Bearer ${process.env.OPENAI_API_KEY}`,
                },
            });
            ...
            console.error('Error retrieving file from OpenAI:', ((_a = error.response) === null || _a === void 0 ? void 0 : _a.data) || error.message);
            throw error;
        }
    },
    /**
    ...
    async removeFileFromAssistant(assistantId, fileId) {
        ...
        try {
            ...
            const deleteResponse = await axios_1.default.delete(`https://api.openai.com/v1/vector_stores/${vectorStoreId}/files/${fileId}`, {
                headers: {
                    'Authorization': `Bearer ${process.env.OPENAI_API_KEY}`,
                    'OpenAI-Beta': 'assistants=v2',
                    'Content-Type': 'application/json',
            ...
            console.error('Error removing file from assistant:', ((_a = error.response) === null || _a === void 0 ? void 0 : _a.data) || error.message);
            throw error;
        }
    },
    /**
    ...
    async deleteFile(fileId) {
        ...
        try {
            ...
            console.error('Error deleting file from OpenAI:', ((_a = error.response) === null || _a === void 0 ? void 0 : _a.data) || error.message);
            throw error;
        }
    }
});
